...
for model_name, model_path in model_paths.items():
    try:
        ...
        st.error(f"{model_name.replace('_', ' ').title()} model file not found. Please check the file path.")

# Load Parkinson's data
try:
    parkinsons_data = pd.read_csv('c:/Users/HP/OneDrive/ドキュメント/medical diagnosis/Medical diagnosis using AI/parkinsons_data.csv')  # Update the file path
except FileNotFoundError:
    st.error("Parkinson's data file not found. Please check the file path.")
